...
var modals_group_ModalsGroup = /*#__PURE__*/function (_DisclosuresGroup) {
  _inherits(ModalsGroup, _DisclosuresGroup);

  var _super = _createSuper(ModalsGroup);
  ...
  function ModalsGroup() {
    ...
    _this.trap = new scripts["FocusTrap"]();
    return _this;
  }
...
var modal_Modal = /*#__PURE__*/function (_Disclosure) {
  ...
  modal_createClass(Modal, [{
    ...
    value: function listen() {
      ...
      this.keyListener.down(scripts["KeyListener"].ESCAPE, this.conceal.bind(this), true, true);
    ...
    value: function handleScroll(isScrollable) {
      if (isScrollable) {
        Object(scripts["removeClass"])(document.documentElement, NO_SCROLL_SELECTOR);
        ...
        Object(scripts["addClass"])(document.documentElement, NO_SCROLL_SELECTOR);
      }
    }
    /**
    ...
    value: function resize(isResizing, e) {
      ...
      if (this.body.scrollHeight > this.body.clientHeight) {
        if (this.body.offsetHeight + this.body.scrollTop >= this.body.scrollHeight) {
          Object(scripts["removeClass"])(this.body, SCROLL_SHADOW_SELECTOR);
        } else {
          Object(scripts["addClass"])(this.body, SCROLL_SHADOW_SELECTOR);
        }
      } else {
        Object(scripts["removeClass"])(this.body, SCROLL_SHADOW_SELECTOR);
      }
    ...
    key: "type",
    get: function get() {
      return scripts["Disclosure"].TYPES.expand;
    }
  }, {
    key: "selector",
    get: function get() {
...
new scripts["Initializer"]('.rf-modal', [modals_Modals]);
